...
export default function SidebarLayout({ role, children }) {
  ...
  const MENU_ITEM_DEFS = {
    ...
    'gta-betting-event-report': { to: r => `/${r}/gta-betting-event-report`, icon: <BarChart3 size={18} />, text: 'GTA Betting Event Report', roles: ['admin','super_admin'] },
    'workplace-schedule': { to: r => `/${r}/workplace-schedule`, icon: <Calendar size={18} />, text: 'Workplace Schedule', roles: ['admin','super_admin'] },
    'gta-teller-management': { to: r => `/${r}/gta-teller-management`, icon: <Users size={18} />, text: 'GTA Teller Management', roles: ['admin','super_admin'] },
