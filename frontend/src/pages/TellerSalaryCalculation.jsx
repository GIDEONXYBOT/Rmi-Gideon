...
export default function TellerSalaryCalculation() {
  ...
  return (
    <div className={`${dark ? 'bg-gray-900 text-white' : 'bg-white text-gray-900'} min-h-screen p-6`}>
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-4xl font-bold mb-2">Teller Salary Calculation</h1>
        <p className={`${dark ? 'text-gray-400' : 'text-gray-600'}`}>Calculate teller salary with overtime hours and base salary (Monday - Friday)</p>
      </div>
              ...
              <table className="w-full">
                <thead className={`${dark ? 'bg-gray-700' : 'bg-gray-100'} border-b ${dark ? 'border-gray-600' : 'border-gray-200'}`}>
                  <tr>
                    ...
                    <th className="px-6 py-4 text-center font-semibold">Weekly OT Total</th>
                  </tr>
                </thead>
                <tbody>
