...
const AVAILABLE_MENU_ITEMS = [
  ...
  { id: "chicken-fight", label: "Chicken Fight", icon: <TrendingUp size={16} />, allowedRoles: ["super_admin", "admin", "supervisor"] },
  { id: "chicken-fight-entries", label: "Chicken Fight Entries", icon: <SettingsIcon size={16} />, allowedRoles: ["super_admin", "admin", "supervisor"] },
