            ...
            <span className="text-green-400 font-medium">
              Total Comm: ₱{draws.reduce((total, draw) => {
                if (draw.details && draw.result1 && draw.result1 !== 'draw') {
                  const winningBetAmount = draw.result1 === 'meron' ? draw.details.redTotalBetAmount :
                                          draw.result1 === 'wala' ? draw.details.blueTotalBetAmount : 0;
                  return total + Math.round(winningBetAmount * 0.055);
                }
                return total;
              }, 0).toLocaleString()}
            </span>
            ...
            <div key={draw.id} className="bg-gray-800 rounded-lg p-3 border border-gray-700">
              ...
              <div className="flex justify-between text-xs text-gray-400">
                ...
                {draw.result1 && draw.result1 !== 'draw' ? (
                  <span>Comm: ₱{draw.details ? Math.round((
                    draw.result1 === 'meron' ? draw.details.redTotalBetAmount :
                    draw.result1 === 'wala' ? draw.details.blueTotalBetAmount :
                    0
                  ) * 0.055).toLocaleString() : '0'}</span>
                ) : null}
              </div>
            </div>
          ))}
